...
public class TeleOpConfig {
    ...
    // DRIVE CONFIG
    public static String DRIVE_PRESET = "LERP"; //"QUADRATIC", "LINEAR"(default, original, raw input), "EXPONENTIAL", "LERP"(smooth linear, ADDS DRIFT), "TANH", "CUBIC_BLEND"

    public static double speedFactor = 0.65; //AKA SENS, range 0 to 1, percentage speed - 1 is full speed, 435 rpm
    ...
    public static double imu_kD = 0.01; //deriv gain, also retune
