...
public class TeleOpConfig {
    ...
    // DRIVE CONFIG
    public static final String DRIVE_PRESET = "EXPONENTIAL";
    ...
    public static boolean USE_PRIORITY_SUPPRESSION = false;
    ...
    public static double TANH_A = 2.5; //a controls the steepness. 1 is linear, 5+ is very steep - DOESNT MATTER IF PRESET ISNT ON TANH
